...
export type BachVariant = VariantProps<typeof badgeVariants>["variant"];

interface BachProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: BachVariant;
}

const Bach: React.FC<BachProps> = ({ className, variant, ...props }) => {
  return <div className={cn(badgeVariants({ variant }), className)} {...props} />;
};

export { Bach, type BachProps };
