...
const iconButtonVariants = tv({
  ...
  variants: {
    variant: {
      table:
        "mtx-text-text hover:mtx-bg-primary-50 focus:mtx-bg-transparent focus:mtx-ring focus:mtx-ring-primary-400 active:mtx-bg-primary-50 active:mtx-text-primary-700",
      toolbar:
        "mtx-text-primary hover:mtx-bg-primary-50 focus:mtx-bg-transparent focus:mtx-ring focus:mtx-ring-primary-400 active:mtx-bg-primary-50 active:mtx-text-primary-700",
