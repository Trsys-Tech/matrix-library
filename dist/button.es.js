...
import { Slottable as b, Slot as d } from "@radix-ui/react-slot";
...
const x = y({
  ...
  ({ className: i, variant: t, size: a, asChild: n = !1, children: o, loading: r, disabled: g, startIcon: s, endIcon: c, ...v }, f) => /* @__PURE__ */ u(n ? d : "button", { className: l(x({ variant: t, size: a, className: i })), ref: f, disabled: g || r, ...v, children: [
    r ? /* @__PURE__ */ e(p, {}) : null,
    s,
