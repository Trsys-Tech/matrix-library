...
const V = "sidebar:state", P = 3600 * 24 * 7, y = "16rem", _ = "18rem", N = "4rem", W = "b", k = i.createContext(null);
function R() {
  const t = i.useContext(k);
  if (!t)
    throw new Error("useSidebar must be used within a SidebarProvider.");
  return t;
}
const $ = i.forwardRef(({ defaultOpen: t = !0, open: e, onOpenChange: a, className: m, style: o, children: s, ...n }, p) => {
  const x = B(), [f, g] = i.useState(t), l = e ?? f, b = i.useCallback(
    (c) => {
      const u = typeof c == "function" ? c(l) : c;
      a ? a(u) : g(u), document.cookie = `${V}=${u}; path=/; max-age=${P}`;
    },
    [a, l]
  ), h = i.useCallback(() => b((c) => !c), [b]);
  i.useEffect(() => {
    const c = (u) => {
      u.key === W && (u.metaKey || u.ctrlKey) && (u.preventDefault(), h());
    };
    return window.addEventListener("keydown", c), () => window.removeEventListener("keydown", c);
  }, [h]);
  const S = l ? "expanded" : "collapsed", M = i.useMemo(
    () => ({
      state: S,
      open: l,
      setOpen: b,
  ...
  return /* @__PURE__ */ r(k.Provider, { value: M, children: /* @__PURE__ */ r(O, { delayDuration: 0, children: /* @__PURE__ */ r(
    "div",
    {
      style: { ...o },
...
const q = i.forwardRef(({ side: t = "left", variant: e = "sidebar", collapsible: a = "offcanvas", className: m, children: o, width: s, widthIcon: n, widthMobile: p, style: x, ...f }, g) => {
  ...
  ) : l || e === "sheet" ? /* @__PURE__ */ r(G, { open: h, onOpenChange: S, ...f, children: /* @__PURE__ */ v(
    H,
    {
      ...
      style: {
        ...t === "left" ? {
          "--sidebar-left-width": p ?? _
        } : {
          "--sidebar-right-width": p ?? _
        }
      },
      side: t,
      children: [
...
const F = i.forwardRef(
  ({ className: t, onClick: e, asChild: a, ...m }, o) => {
    const { toggleSidebar: s, state: n } = R();
    return /* @__PURE__ */ r(
      a ? w : "button",
      {
        ref: o,
...
}), ot = i.forwardRef(({ asChild: t = !1, isActive: e = !1, variant: a = "default", size: m = "default", tooltip: o, className: s, ...n }, p) => {
  const x = t ? w : "button", { isMobile: f, state: g } = R(), l = /* @__PURE__ */ r(
    x,
    {
      ref: p,
...
const lt = i.forwardRef(({ className: t, showIcon: e = !1, ...a }, m) => /* @__PURE__ */ v(
  "div",
  {
    ref: m,
