...
import { XMark as I, CircleXmark as ae, ChevronDown as se, Check as D } from "@trsys-tech/matrix-icons";
import { cn as p } from "./utils.es.js";
import { Status as T } from "./status.es.js";
import { Button as le } from "./button.es.js";
...
const K = me({
  ...
  const l = k !== void 0, [U, x] = a.useState(L), r = l ? k : U, [Y, i] = a.useState(!1), g = a.useRef(null), [Z, P] = a.useState(""), [F, M] = a.useState(!1), [n, w] = a.useState(
    ...
    l || x([]), o([]), f && w(new Map(d.map((e) => [e.value, e])));
  }, [o, f, d, l]), ee = a.useCallback(() => {
    i((e) => !e);
  }, []), te = a.useCallback(() => {
    const e = r.slice(0, u);
    l || x(e), o(e);
  }, [u, r, o, l]), re = a.useCallback(() => {
    if (r.length === n.size)
      v();
    else {
  ...
  return a.useEffect(() => {
  ...
  }, [r]), /* @__PURE__ */ s(oe, { open: Y, onOpenChange: i, modal: z, children: [
    /* @__PURE__ */ t(ne, { asChild: !0, children: /* @__PURE__ */ t(
      le,
      {
        ...
        children: /* @__PURE__ */ t(S, { children: r.length > 0 ? /* @__PURE__ */ s("div", { className: "mtx-flex mtx-justify-between mtx-items-center mtx-w-full", children: [
          /* @__PURE__ */ s("div", { className: "mtx-flex mtx-flex-wrap mtx-items-center mtx-gap-2", ref: g, children: [
            r.slice(0, u).map((e) => {
              const m = n.get(e), c = m?.icon;
              return /* @__PURE__ */ s(T, { className: p(K({ variant: C }), { "text-gray-400 bg-gray-200": j || h }), children: [
                /* @__PURE__ */ t(
                  I,
                  {
            ...
            r.length > u && /* @__PURE__ */ s(T, { className: p(K({ variant: C })), children: [
              `+ ${r.length - u} ${W}`,
              /* @__PURE__ */ t(
                ae,
                {
          ...
          /* @__PURE__ */ s("div", { className: "mtx-flex mtx-items-center mtx-justify-between mtx-gap-1", children: [
            /* @__PURE__ */ t(
              I,
              {
                role: "button",
        ...
        ] }) : /* @__PURE__ */ t(S, { children: h && b ? b : V }) })
      }
    ) }),
    /* @__PURE__ */ t(ce, { className: "mtx-w-auto mtx-p-0", align: "start", onEscapeKeyDown: () => i(!1), children: /* @__PURE__ */ s(xe, { className: "mtx-w-[--radix-popper-anchor-width] mtx-max-h-[--radix-popper-available-height]", children: [
      /* @__PURE__ */ t(ie, { placeholder: q, onKeyDown: _, value: Z, onValueChange: P }),
      /* @__PURE__ */ s(de, { className: "", children: [
        /* @__PURE__ */ t(ue, { children: O }),
        /* @__PURE__ */ s(R, { children: [
          H && /* @__PURE__ */ s(y, { onSelect: re, className: "mtx-cursor-pointer", children: [
            /* @__PURE__ */ t(
              "div",
              {
                className: p(
          ...
          Array.from(n.values()).map((e) => {
            ...
            return /* @__PURE__ */ s(y, { onSelect: () => E(e.value), className: "mtx-cursor-pointer", children: [
              /* @__PURE__ */ t(
                "div",
                {
                  className: p(
        ...
        /* @__PURE__ */ t(pe, {}),
        /* @__PURE__ */ t(R, { children: /* @__PURE__ */ s("div", { className: "mtx-flex mtx-items-center mtx-justify-between", children: [
          r.length > 0 && /* @__PURE__ */ s(S, { children: [
