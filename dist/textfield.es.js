...
const j = F({
  ...
  ({
    ...
    const w = (a) => {
      x === "number" && a.target.blur(), i && i(a);
    };
    return /* @__PURE__ */ v("div", { ...g, className: o(j({ size: d, className: s })), "aria-disabled": r, children: [
      m,
      /* @__PURE__ */ n(
        "input",
        {
      ...
      typeof t == "string" || typeof t == "number" ? /* @__PURE__ */ n("span", { className: "mtx-inline-flex mtx-items-center mtx-px-2 mtx-text-xs mtx-font-medium mtx-text-primary mtx-bg-primary-50 mtx-m-0.5 mtx-rounded-sm mtx-h-[calc(100%-4px)]", children: t }) : t,
      l
    ] });
  }
);
