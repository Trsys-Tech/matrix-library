...
import { Elipsis as l, ChevronRight as n } from "@trsys-tech/matrix-icons";
const d = s.forwardRef(({ ...r }, e) => /* @__PURE__ */ t("nav", { ref: e, "aria-label": "breadcrumb", ...r }));
...
const b = ({ children: r, className: e, ...a }) => /* @__PURE__ */ t("li", { role: "presentation", "aria-hidden": "true", className: m("[&>svg]:mtx-w-3.5 [&>svg]:mtx-h-3", e), ...a, children: r ?? /* @__PURE__ */ t(n, {}) });
...
const N = ({ className: r, ...e }) => /* @__PURE__ */ i("span", { role: "presentation", "aria-hidden": "true", className: m("mtx-flex mtx-h-9 mtx-w-9 mtx-items-center mtx-justify-center", r), ...e, children: [
  /* @__PURE__ */ t(l, { className: "mtx-h-4 mtx-w-4" }),
