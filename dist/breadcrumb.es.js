...
import { ChevronRight as n, Elipsis as d } from "@trsys-tech/matrix-icons";
...
const N = ({ children: r, className: e, ...a }) => /* @__PURE__ */ s("li", { role: "presentation", "aria-hidden": "true", className: t("[&>svg]:w-3.5 [&>svg]:h-3", e), ...a, children: r ?? /* @__PURE__ */ s(n, {}) });
