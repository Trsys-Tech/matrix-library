...
import { DateOnlyString, DatePickerProps } from '../date-picker/DatePicker';
/**
 ...
 */
type FormDatePickerProps<TFieldValues extends FieldValues, TName extends FieldPathByValue<TFieldValues, DateOnlyString | undefined>> = Omit<ControllerProps<TFieldValues, TName>, "render"> & React.ComponentProps<typeof FormItem> & {
 ...
 * />
 */
declare const FormDatePicker: <TFieldValues extends FieldValues, TName extends FieldPathByValue<TFieldValues, DateOnlyString | undefined>>(props: FormDatePickerProps<TFieldValues, TName>) => import("react").JSX.Element;
