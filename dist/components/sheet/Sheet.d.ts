...
declare const sheetVariants: TVReturnType<{
    side: {
        top: string;
        bottom: string;
        left: string;
...
}, undefined, "mtx-fixed mtx-z-50 mtx-gap-4 mtx-bg-background mtx-p-6 mtx-shadow-lg mtx-transition mtx-ease-in-out data-[state=closed]:mtx-duration-300 data-[state=open]:mtx-duration-500 data-[state=open]:mtx-animate-in data-[state=closed]:mtx-animate-out", TVConfig<{
    side: {
        top: string;
        bottom: string;
        left: string;
