...
declare const FormDuration: <TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>>(props: FormDurationProps<TFieldValues, TName>) => import("react").JSX.Element;
