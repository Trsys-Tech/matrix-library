...
declare const FormDateRangePicker: <TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>>(props: FormDateRangePickerProps<TFieldValues, TName>) => import("react").JSX.Element;
