...
declare const FormMultiSelect: <TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>>(props: FormMultiSelectProps<TFieldValues, TName>) => import("react").JSX.Element;
