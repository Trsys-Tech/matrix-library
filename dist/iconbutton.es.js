...
import f from "react";
import { Slottable as u, Slot as m } from "@radix-ui/react-slot";
...
const l = p({
  ...
  ({ asChild: t, children: n, className: o, disabled: a, loading: r, variant: s, size: i, ...c }, g) => /* @__PURE__ */ b(t ? m : "button", { className: d(l({ variant: s, size: i, className: o })), disabled: a || r, ref: g, ...c, children: [
    r ? /* @__PURE__ */ e(v, {}) : null,
    /* @__PURE__ */ e(u, { children: n })
  ] })
);
export {
  B as IconButton
