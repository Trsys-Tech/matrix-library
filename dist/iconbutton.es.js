...
import f from "react";
import { Slot as u, Slottable as m } from "@radix-ui/react-slot";
...
const l = p({
  ...
  ({ asChild: t, children: n, className: o, disabled: a, loading: r, variant: s, size: i, ...c }, g) => /* @__PURE__ */ b(t ? u : "button", { className: d(l({ variant: s, size: i, className: o })), disabled: a || r, ref: g, ...c, children: [
    r ? /* @__PURE__ */ e(v, {}) : null,
